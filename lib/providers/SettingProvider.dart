...
class SettingProvider extends ChangeNotifier {
  ...
  Color GetBackground() {
    return currentTheme == ThemeMode.dark ? Colors.black : Color(0xFFDEEBDA);
  }
  ...
  Future<void> SaveTheme(ThemeMode theme) async {
    String mode = theme == ThemeMode.dark ? 'dark' : 'light';
  ...
  Future<void> loadLocale() async {
    ...
    if (locale != null) {
      locale == 'en' ? currentLocale = 'en' : currentLocale = 'ar';
    }
  }
}
